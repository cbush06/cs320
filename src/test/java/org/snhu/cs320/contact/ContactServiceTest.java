...
class ContactServiceTest {
    ...
    @Test
    void deleteFail() {
        assertThat(ContactService.getInstance().delete("non-existent id"))
            .isFalse();
    }
    ...
    void updateSuccess() throws ValidationException {
        ...
        assertThat(ContactService.getInstance().update("12345", modified))
            .isTrue();
    ...
    void updateFail() throws ValidationException {
        ...
        assertThat(ContactService.getInstance().update("12345", updated))
            .isFalse();
    }
}
